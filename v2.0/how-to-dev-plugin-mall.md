...
登录授权  
![](v2.0/images/yesyesapi_20200312161449_efd01b62808b98b1a2b0ae7840f250d6.png)

商城首页   
![](v2.0/images/yesyesapi_20200312161514_5df9836c78a648a63bfab4799d9adc9d.png)

商品详情页  
![](v2.0/images/yesyesapi_20200312161539_e620953a7df44b61827ffb216438c018.png)

购买页   
![](v2.0/images/yesyesapi_20200312161558_72e33a6ce66cf468cbe40bf1d2335584.png)

朋友圈发现页  
![](v2.0/images/yesyesapi_20200312161618_1299fbe415b777a7faa592617d293dc5.png)

我的页面  
![](v2.0/images/yesyesapi_20200312161642_53ed889efb0d67f955f8436997ada73a.png)

我的订单  
![](v2.0/images/yesyesapi_20200312161658_b89a0e5509d217fdde2abf0a6a77f863.png)
...
![](v2.0/images/yesyesapi_20200312162947_65d177fe8feeb76409f9c833e27cecea.png)

### 运营平台界面

配置的运营平台管理界面，目前只是实现了一个订单查看页面，其他页面可自行添加。

![](v2.0/images/yesyesapi_20200312162046_02a6d27a182469487fcc4d93559a914f.png)
...
可以看到刚才开发的新接口。  
![](v2.0/images/yesyesapi_20200312164004_ab89ba05034098e09830dbac2a4cd5c3.png)

通过在线测试，可以测试接口是否正常。  

![](v2.0/images/yesyesapi_20200312164136_c16becff458169366b416470cde14a16.png)
...
正常情况可以看到类似：  
![](v2.0/images/yesyesapi_20200312164248_5b41587dc12617a67b89d5c7278e923a.png)
...
![](v2.0/images/yesyesapi_20200312164532_eb3614106f59b969616a5e560b46ad50.jpeg)

创建一个新的小程序。  

![](v2.0/images/yesyesapi_20200312164620_52659e63525b9ab65abc3f9b148b343c.png)

在本发开发调试时，记得要在项目右上角的【详情】-【本地配置】，勾选：不校验合法域名、web-view（业务域名）、TLS 版本以及 HTTPS 证书。不设置的话，本地无法请求你本地的接口。  

![](v2.0/images/yesyesapi_20200312164833_4002d7794c3d28c587f2eb773ec04def.png)

随后，也是很重要的一步，就是把你本地开发环境的接口域名或者最终正式环境的接口域名，配置到app.js文件中。  

![](v2.0/images/yesyesapi_20200312164943_8285b635ad82e38b0dfd43c3d9816f12.png)
...
![](v2.0/images/yesyesapi_20200312165901_0164ea172a3ac11f7b4c903116a0c23c.png) 
...
![](v2.0/images/yesyesapi_20200312170232_2c84ecc98f23d3fb0be2eacff050eb03.png)
...
![](v2.0/images/yesyesapi_20200312171440_a49a41dd4857148a97c3d2c42f4f197c.png)
...
![](v2.0/images/yesyesapi_20200312171925_0e66dba0c5087a27824b3b172ddafca2.png) 
...
![](v2.0/images/yesyesapi_20200312172216_d66c3948e8360619d1163d25ec64bb87.png)

如果安装后提示失败，那么很可能是文件和目录没有写入权限。  
![](v2.0/images/yesyesapi_20200312172402_99dc9f7a197ef72c56df09bf78c86568.png) 
...
成功安装后，可以看到类似以下界面。  
![](v2.0/images/yesyesapi_20200312172610_ba1dc01094bdda767db031faf31bbb34.png)
